...
export function ArrowLeftCircleIcon({ size = 24, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="1.5" />
      <path d="M12 8l-4 4 4 4M16 12H8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

export function ArrowUpLeftIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      <path d="M17 17L7 7M7 14.5V7h7.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" aria-hidden="true" {...p}>
      <g transform="translate(20,20) scale(1.4) translate(-20,-20)">
        <path d="M25.5 14.5H25.51M15 10H25C27.7614 10 30 12.2386 30 15V25C30 27.7614 27.7614 30 25 30H15C12.2386 30 10 27.7614 10 25V15C10 12.2386 12.2386 10 15 10ZM24 19.37C24.1234 20.2022 23.9813 21.0522 23.5938 21.799C23.2063 22.5458 22.5931 23.1514 21.8416 23.5297C21.0901 23.9079 20.2384 24.0396 19.4078 23.9059C18.5771 23.7723 17.8098 23.3801 17.2148 22.7852C16.6199 22.1902 16.2277 21.4229 16.0941 20.5922C15.9604 19.7616 16.0921 18.9099 16.4703 18.1584C16.8486 17.4069 17.4542 16.7937 18.201 16.4062C18.9478 16.0187 19.7978 15.8766 20.63 16C21.4789 16.1259 22.2649 16.5215 22.8717 17.1283C23.4785 17.7352 23.8741 18.5211 24 19.37Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    </svg>
  );
}
